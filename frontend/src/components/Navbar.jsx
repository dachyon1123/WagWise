  ...
  return (
    <div className="navbar bg-base-100 p-0">
      <div className="">
        ...
        <Link to="/">
          <a className="btn btn-ghost text-xl">WagWise</a>
        </Link>
      </div>
      ...
      <div className="flex flex-row items-center md:w-full justify-end md:my-0 my-4">
        <svg
          width="28px"
          height="28px"
          viewBox="0 0 24 24"
        ...
        <a className="md:mr-10 md:ml-2 md:text-base text-xs" href="tel:+15128253634">
          +1 (512)-825-3634
        </a>
        <svg
          width="28px"
